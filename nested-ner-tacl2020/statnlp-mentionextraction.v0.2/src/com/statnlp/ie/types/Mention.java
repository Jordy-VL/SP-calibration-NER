...
public class Mention implements Serializable, Comparable<Mention>{
	...
	public Mention(int bIndex, int eIndex, int head_bIndex, int head_eIndex, Tag tag){
	...
	public boolean spanMatches(Mention m){
		return this._seg.equals(m._seg)
				&& this._tag.equals(m._tag);
	}
	...
	public boolean equals(Object o){
		if(o instanceof Mention){
			Mention m = (Mention)o;
			return this._seg.equals(m._seg)
					&& this._head_seg.equals(m._head_seg)
					&& this._tag.equals(m._tag);
		}
		return false;
	}
