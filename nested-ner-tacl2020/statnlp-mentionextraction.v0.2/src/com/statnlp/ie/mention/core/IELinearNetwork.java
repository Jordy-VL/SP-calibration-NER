...
public class IELinearNetwork extends TableLookupNetwork{
	...
	public IELinearNetwork(IELinearInstance inst, IELinearFeatureManager fm) {
		super(inst, fm);
	}
	
	public IELinearNetwork(IELinearInstance inst, IELinearFeatureManager fm, long[] nodes, int[][][] children, int numNodes) {
...
//	@Override
	...
	public boolean contains(IELinearNetwork network){
//		if (true)
//		return true;
