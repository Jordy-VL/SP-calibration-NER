...
public class IELinearNetwork_CONLL2003 extends TableLookupNetwork{
	...
	public IELinearNetwork_CONLL2003(IELinearInstance inst, IELinearFeatureManager_CONLL2003 fm) {
		super(inst, fm);
	}
	
	public IELinearNetwork_CONLL2003(IELinearInstance inst, IELinearFeatureManager_CONLL2003 fm, long[] nodes, int[][][] children, int numNodes) {
...
//	@Override
	...
	public boolean contains(IELinearNetwork_CONLL2003 network){
//		if (true)
//		return true;
