...
public class IELinearFeatureManager_CONLL2003 extends FeatureManager{
	...
	private IELinearNetwork_CONLL2003 _network;
	private IELinearInstance _inst;
	private TextSpan _span;
	private final FeatureArray _EMPTY_ = new FeatureArray(this._param);
	
	public IELinearFeatureManager_CONLL2003(HGrammar g, NetworkParam param) {
		super(g, param);
...
//		System.exit(1);
	...
	public void setNetwork(Network network) {
		this._network = (IELinearNetwork_CONLL2003)network;
