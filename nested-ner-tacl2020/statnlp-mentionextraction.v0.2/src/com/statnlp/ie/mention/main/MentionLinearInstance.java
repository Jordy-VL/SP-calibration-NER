...
public class MentionLinearInstance extends IELinearInstance{
	...
	public MentionLinearInstance(int id, TextSpan span, MentionTemplate info) {
		super(id, span);
		this._info = info;
	}
	
	public MentionLinearInstance removeLabels(){
		...
		return new MentionLinearInstance(-this._id, uspan, this._info);
	}
