...
public class HPattern implements Serializable{
	...
	public static HPattern create(String[] form, HGrammar g){
		return g.addHybridPattern(form);
	}
	
	protected HPattern(Pattern[] patterns){
		assert patterns.length == 2;
		this._patterns = patterns;
	}
	
	public boolean isTerminal(){
		return this._g.isTerminal(this);
	}
	...
	public boolean equals(Object o){
		if(o instanceof HPattern)
			return Arrays.equals(this._patterns, ((HPattern)o)._patterns);
		return false;
	}
