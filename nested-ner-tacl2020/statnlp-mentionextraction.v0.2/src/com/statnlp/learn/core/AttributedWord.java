...
public class AttributedWord extends Word{
	...
	private void addNERAttributes_new(){
		...
		if(WordUtil.isInitialCapsOnly(curr)){
			this.addAttribute(type, "isInitialCapsOnly-yes");
		}
...
//		if(this._attrs.containsKey(attName))
//			throw new RuntimeException("The attribute "+attName+" already exists.");
		if(!this._attrs.containsKey(attName))
