...
CORPUS_DIR_PATH: str = "./ACE2004/ace_multilang_tr_LDC2005T09/ace_multilang_tr/data/English/"
...
class Tokenizer:
    ...
    def __init__(self) -> None:
        os.environ['CORENLP_HOME'] = '{}/stanford-corenlp-4.2.0'.format(os.environ['HOME'])
    ...
    def tokenize(self, doc: str) -> List[Sentence]:
        ...
        for sentence in sentences:
            tokenizer_annotation \
                = self.client.annotate(sentence.text, annotators=['tokenize'],
